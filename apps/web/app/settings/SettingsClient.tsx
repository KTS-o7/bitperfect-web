                                 ...
                                 <div className="flex flex-col gap-3">
                                    {confirmClear ? (
                                        <div className="flex flex-wrap items-center gap-3">
                                            ...
                                            <div className="flex gap-2">
                                                <button
                                                    ...
                                                    className="px-4 py-2 bg-red-500 text-white text-[10px] font-mono uppercase tracking-widest hover:bg-red-600 transition-colors"
                                                >
                                                    Yes, clear everything
                                                </button>
                                                <button
                                                    onClick={() => setConfirmClear(false)}
                                                    className="px-4 py-2 border border-foreground/20 text-[10px] font-mono uppercase tracking-widest hover:bg-foreground/5 transition-colors"
                                                >
                                                    Cancel
                                                </button>
                                            </div>
                                        ...
                                        <button
                                            ...
                                            className="flex items-center justify-center gap-2 px-6 py-3 border border-red-500/50 text-red-500 hover:bg-red-500 hover:text-white transition-all text-[10px] font-mono uppercase tracking-widest self-start"
                                        >
